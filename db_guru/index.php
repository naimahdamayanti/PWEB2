                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td class="text-center">
                        <a href="edit-guru.php?id=<?php echo $row['nuptk'] ?>" class="btn btn-sm btn-primary">EDIT</a>
                        <a href="hapus-guru.php?id=<?php echo $row['nuptk'] ?>" class="btn btn-sm btn-danger">HAPUS</a>
                      </td>
                  </tr>
